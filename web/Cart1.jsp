                                                ...
                                                <c:forEach items="${listProduct}" var="p">
                                                    <c:if test="${i.product.id == p.id}">
                                                        <tr>
                                                            ...
                                                            <td class="align-middle"><strong>${p.price*0.9}$</strong></td>
                                                            ...
                                                            <td class="align-middle">
                                                                <a href="subAmountCart?productID=${i.product.id}&amount=${i.quantity}"><button class="btnSub">-</button></a> 
                                                                <strong>${i.quantity}</strong>
                                                                <a href="addAmountCart?productID=${i.product.id}&amount=${i.quantity}"><button class="btnAdd">+</button></a>
                                                            </td>
                                                            <td class="align-middle"><a href="deleteCart?productID=${i.product.id}" class="text-dark">
