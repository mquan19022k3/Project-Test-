            ...
            <main>
                <div class="container">
                    <section class="mb-5">
                        ...
                        <div class="col-md-6">
                            <h5>${detail.title}</h5>
                            <p><span class="mr-1"><strong>VNĐ${String.format("%.02f",detail.price*0.9) }</strong></span><span
                                    class="text-grey"><strong><s>VNĐ${detail.price }</s></strong></span></p>
                ...
                <div class="classic-tabs">
                    ...
                    <div class="tab-content" id="advancedTabContent">
                        <div class="tab-pane fade show active" id="description" role="tabpanel" aria-labelledby="description-tab">
                            ...
                            <h6>VNĐ${String.format("%.02f",detail.price*0.9) }</h6>
                            <p class="pt-1">${detail.description}</p>
                        </div>
                            ...
                            <div class="col-md-6 col-lg-3 mb-5">
                                <div class="">
                                    ...
                                    <div class="pt-4">
                                        ...
                                        <h5>${o.title }</h5>
                                        <p><span class="text-danger mr-1"><strong>${String.format("%.02f",o.price*0.9) }VNĐ</strong></span><span
